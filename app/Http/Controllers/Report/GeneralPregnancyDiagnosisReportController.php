...
use App\Services\Report\Strategies\GeneralPregnancyDiagnosisReportStrategy;
use Barryvdh\DomPDF\Facade\Pdf;

class GeneralPregnancyDiagnosisReportController extends Controller
{
    public function __construct(
        private readonly ReportRunner $runner,
        private readonly GeneralPregnancyDiagnosisReportStrategy $strategy
    ) {}
    ...
    public function export(ReportFilterRequest $request)
    {
        ...
        $pdf = Pdf::loadView('reports.general-pregnancy-diagnosis', compact('data', 'generatedAt'));
        ...
        // Descarga el PDF
        $filename = 'informe-general-pregnancy-diagnosis-' . now()->format('Y-m-d') . '.pdf';
