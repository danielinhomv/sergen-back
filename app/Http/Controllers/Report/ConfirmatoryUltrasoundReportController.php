...
use App\Services\Report\Strategies\ConfirmatoryUltrasoundReportStrategy;
use Barryvdh\DomPDF\Facade\Pdf;

class ConfirmatoryUltrasoundReportController extends Controller
{
    public function __construct(
        private readonly ReportRunner $runner,
        private readonly ConfirmatoryUltrasoundReportStrategy $strategy
    ) {}
    ...
    public function export(ReportFilterRequest $request)
    {
        ...
        $pdf = Pdf::loadView('reports.confirmatory-ultrasound', compact('data', 'generatedAt'));
        ...
        // Descarga el PDF
        $filename = 'informe-confirmatory-ultrasound-' . now()->format('Y-m-d') . '.pdf';
